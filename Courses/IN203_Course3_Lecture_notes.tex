...
#   pragma omp parallel for schedule(dynamic,10000)
  ...
  Attendre que la suite $u_{n}$ atteigne le nombre un prends de plus en plus de temps au fur et à mesure qu'on choisit un $u_{0}$ grand et la probabilité de trouver un nombre d'itérations conséquent augmente. 
